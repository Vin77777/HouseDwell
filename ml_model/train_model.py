...
# Run this file to train and save
if __name__ == "__main__":
    data = load_and_preprocess_data("Corrected_Rental_Dataset.csv")
    engineered_df, _ = engineer_features(data, is_training=True)
    train_and_save_model(engineered_df)
